...
public class Main : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Vector3 spawnPos = Camera.main.ViewportToWorldPoint(new Vector3(0.07f, Random.Range(0.5f, 1f), Mathf.Abs(Camera.main.transform.position.z)));
            spawnPos.z = 0;
        ...
        if (!isGameOver)
        {
            ...
            moveDirection = speed * Time.deltaTime * new Vector3(moveX, moveY, 0);
            ((PlayerModel)playerManager).Move(moveDirection);
        }
